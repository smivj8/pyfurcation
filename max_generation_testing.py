...
branching_angle_tes = 35*np.pi/180
...
for j in range(1, n_gens):
    ...
    gen_j_parameters = [parent_radius_j, 0, daughter_radius_j, daughter_length_j, outer_radius_j ,branching_angle_tes, carina_angle_test, 1]
